        ...
        rows.append(
            {
                ...
                "transition_kind": str(action_result.transition_kind or ""),
                "transition_detail": str(action_result.transition_detail or ""),
                "navigation_status": action_result.navigation_status,
                "network_errors": list(action_result.network_errors or []),
                "redirect_chain": list(action_result.redirect_chain or []),
                "history_api_signal": str(action_result.history_api_signal or ""),
