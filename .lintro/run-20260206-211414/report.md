...
| ------------------------------------------------------------------------------------------ | ---- | ---- | -------------------------------------------------------------- |
| src/flowscout/discovery/actions.py                                                         | 0    |      | Reformatted file                                               |
| src/flowscout/core/navigator.py                                                            | 0    |      | Reformatted file                                               |
| reports/2026/02.February/06-02-2026/12.58.21/tests.py                                      | 0    |      | Reformatted file                                               |
...
| /Users/eiteldagnin/Code/ui-framework/src/flowscout/core/navigator.py                       | 144  | E501 | Line 144 exceeds line length limit (Line too long (91 > 88))   |
| /Users/eiteldagnin/Code/ui-framework/src/flowscout/discovery/actions.py                    | 343  | E501 | Line 343 exceeds line length limit (Line too long (98 > 88))   |
...
| File                                              | Line | Code   | Message                 |
| ------------------------------------------------- | ---- | ------ | ----------------------- |
| .lintro/run-20260206-205244/report.html           | 1    | FORMAT | Code style issues found |
| .lintro/run-20260206-205244/report.md             | 1    | FORMAT | Code style issues found |
